...
public class BookController {
	...
	@RolesAllowed("ADMIN")
	@RequestMapping(value = "/books/remove/{bookId}", method = RequestMethod.DELETE)
	public String deleteBook(@RequestParam("id") Long id, Model model) {
		model.addAttribute("infoRemove", "Book has been removed!");
	...
	public String find(@ModelAttribute("book") BookTo foundBook, Model model) {
		List<BookTo> books = bookService.findBookByTitleOrAuthor(foundBook);
